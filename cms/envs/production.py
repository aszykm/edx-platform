...
AZURE_ACCOUNT_NAME = AUTH_TOKENS["AZURE_ACCOUNT_NAME"]
if AZURE_ACCOUNT_NAME == "":
    AZURE_ACCOUNT_NAME = None

AZURE_ACCOUNT_KEY = AUTH_TOKENS["AZURE_ACCOUNT_KEY"]
if AZURE_ACCOUNT_KEY == "":
    AZURE_ACCOUNT_KEY = None

AZURE_CONTAINER = AUTH_TOKENS.get('AZURE_CONTAINER', 'openedx')
...
COURSE_IMPORT_EXPORT_CONTAINER = ENV_TOKENS.get('COURSE_IMPORT_EXPORT_CONTAINER', '')

if COURSE_IMPORT_EXPORT_BUCKET:
    COURSE_IMPORT_EXPORT_STORAGE = 'contentstore.storage.ImportExportS3Storage'
elif COURSE_IMPORT_EXPORT_CONTAINER:
    COURSE_IMPORT_EXPORT_STORAGE = 'contentstore.storage.ImportExportAzureStorage'
else:
