...
class CertificateDataSerializer(serializers.Serializer):
    ...
    request_cert_url = serializers.SerializerMethodField()
    ...
    def get_request_cert_url(self, cert_data):
        return reverse('generate_user_cert', args=[self.context['course_key']])
